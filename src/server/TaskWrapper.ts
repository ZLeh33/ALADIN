...
import { generateExperimentierenDataMain } from "../Tasks/Experimentieren/wrapperFunctionCallPython";
import fs from "fs";
...
const generators: { [key: string]: any } = {
	...
	generateExperimentierenDataMain: generateExperimentierenDataMain
};
