import { TaskGenerator } from "../../Legacy/genericGraphs/TaskGenerator";
import { Constructor } from "../../Legacy/genericGraphs/Utility";
import { Gozintograph, GozintographVertex } from "./WrapperDecisionTree";
import { GozintographGenerator2, GozintographConfig } from "./WrapperDecisionTree";

export class DecisionTreeTaskGenerator extends TaskGenerator<Gozintograph, GozintographConfig> {
    constructor(
        graphConstructor: Constructor<Gozintograph> = Gozintograph,
        generatorConstructor: Constructor<GozintographGenerator2> = GozintographGenerator2
    ) {
