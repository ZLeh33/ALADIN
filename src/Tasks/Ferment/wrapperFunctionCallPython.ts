...
function parameterBearbeitenUndSpeichern(parameter: any){
	...
	for (let i = 0; i < phasenanzahl; i++) {
		if (Array.isArray(frontendEingaben.userDataMatrix[i][0])) {
			zuluft[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][0][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][0][0]);
			feed[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][2][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][2][0]);
			drehzahl[i] = isNaN(parseFloat(frontendEingaben.userDataMatrix[i][4][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][4][0]);
			druck[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][5][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][5][0]);
			dauer[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][6][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][6][0]);
			bolusC[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][1][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][1][0]);
			bolusN[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][3][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][3][0]);
		} else {
			zuluft[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][0])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][0]);
			feed[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][2])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][2]);
			drehzahl[i] = isNaN(parseFloat(frontendEingaben.userDataMatrix[i][4])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][4]);
			druck[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][5])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][5]);
			dauer[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][6])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][6]);
			bolusC[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][1])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][1]);
			bolusN[i] 	= isNaN(parseFloat(frontendEingaben.userDataMatrix[i][3])) ? 0 : parseFloat(frontendEingaben.userDataMatrix[i][3]);
		}
	}
