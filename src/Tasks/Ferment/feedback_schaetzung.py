    ...
    for phase in loesung:
        ...
        if relative_differenz <= 20:
            ...
            if phase_schatzung < phase_loesung:
                ...
                phase_feedback["message"] = f"Du musst hoeher schaetzen! Deine Schaetzung von {phase_schatzung} fuer {phase} ist mehr als 100% entfernt."
            else:
                phase_feedback["status"] = "Zu hoch"
                phase_feedback["message"] = f"Du musst niedriger schaetzen! Deine Schaetzung von {phase_schatzung} fuer {phase} ist mehr als 100% entfernt."
